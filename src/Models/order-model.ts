...
class OrderModel {
    ...
    private static validationScheme = Joi.object({
        ...
        dedication_name: Joi.alternatives().conditional("dedicate", { is: true, then: Joi.alternatives().conditional("for_self", { is: true, then: Joi.boolean().required(), otherwise: Joi.boolean().optional() }), otherwise: Joi.boolean().optional() }),
