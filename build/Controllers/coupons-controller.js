...
router.get("/coupons", verify_user_1.default.verifyAdmin, function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var allCouponS, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, coupon_logic_1.default.getAllCoupons(true)];
            case 1:
                allCouponS = _a.sent();
                res.json(allCouponS);
                return [3 /*break*/, 3];
...
router.post("/coupons", verify_user_1.default.verifyAdmin, function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var coupon, addedCoupon, err_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                ...
                return [4 /*yield*/, coupon_logic_1.default.addCoupon(coupon)];
            case 1:
                addedCoupon = _a.sent();
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                req.body.discount = +req.body.discount;
                coupon = new coupon_model_1.default(req.body);
                return [4 /*yield*/, coupon_logic_1.default.updateCoupon(req.params.id, coupon)];
            case 1:
