...
var nodejs_jsencrypt_1 = require("nodejs-jsencrypt");
...
var EncryptionService = /** @class */ (function () {
    ...
    EncryptionService.prototype.setKey = function () {
        return __awaiter(this, void 0, void 0, function () {
            var raw_key, stripedTags;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, promises_1.default.readFile(config_1.default.publicKey, "utf-8")];
                    case 1:
                        raw_key = _a.sent();
                        stripedTags = raw_key.replace(/-----BEGIN [^\n]+-----/, '').replace(/-----END [^\n]+-----/, '').replace(/\s+/g, '');
                        this.publicKey = new nodejs_jsencrypt_1.JSEncrypt();
    ...
    EncryptionService.prototype.rsaEncrypt = function (plainText) {
        if (!plainText)
            return null;
        var cipherText = this.publicKey.encrypt(plainText);
    ...
    EncryptionService.prototype.sha256 = function (plainText) {
        if (!plainText)
            return null;
        return (0, crypto_1.createHmac)("sha256", this.salt).update(plainText).digest("hex");
    };
